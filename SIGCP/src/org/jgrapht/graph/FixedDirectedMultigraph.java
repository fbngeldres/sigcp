 ...
 *
 * $Id: FixedDirectedMultigraph.java,v 1.1 2012-05-22 21:37:22 alfredo_alfonzo Exp $
 *
 * Changes
 * -------
 ...
 */
public class FixedDirectedMultigraph extends AbstractBaseGraph<String, TaggedEdge> implements DirectedGraph<String, TaggedEdge> {
	 ...
	 */
	public FixedDirectedMultigraph() {
		super(new FixedClassBasedEdgeFactory(), true, true);
	}
}

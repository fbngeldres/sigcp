 ...
 * Contributor(s):   -
 *
 * $Id: ParanoidGraph.java,v 1.1 2012-05-22 21:37:22 alfredo_alfonzo Exp $
 *
 * Changes
 * -------
 ...
 * 
 * @author John Sichi
 * @version $Id: ParanoidGraph.java,v 1.1 2012-05-22 21:37:22 alfredo_alfonzo
 *          Exp $
 */
	...
	private static <T> void verifyAdd(Set<T> set, T t) {
		for (T o : set) {
			...
			if (o.equals(t) && (o.hashCode() != t.hashCode())) {
				throw new IllegalArgumentException("ParanoidGraph detected objects " + "o1 (hashCode=" + o.hashCode()
						+ ") and o2 (hashCode=" + t.hashCode() + ") where o1.equals(o2) " + "but o1.hashCode() != o2.hashCode()");
			}
		}
	}
}

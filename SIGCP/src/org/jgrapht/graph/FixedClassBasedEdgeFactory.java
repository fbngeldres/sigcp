 ...
 *
 * $Id: FixedClassBasedEdgeFactory.java,v 1.1 2012-05-22 21:37:22 alfredo_alfonzo Exp $
 *
 * Changes
 * -------
 ...
 * @since Jul 14, 2003
 */
public class FixedClassBasedEdgeFactory implements EdgeFactory<String, TaggedEdge>, Serializable {
	...
	public FixedClassBasedEdgeFactory() {
	}
	 ...
	 */
	public TaggedEdge createEdge(String source, String target) {
		return new TaggedEdge();
	}
}

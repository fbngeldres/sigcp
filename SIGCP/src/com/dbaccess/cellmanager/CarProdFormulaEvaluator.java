...
public class CarProdFormulaEvaluator implements FormulaEvaluator {
	...
	public static final Double PORC_HUMEDAD_CRUDO_NEGRO = 0d; // Por petición
	// del usuario
	public static final Double CAL_RECHAZADA = 0d; // Por petición del usuario

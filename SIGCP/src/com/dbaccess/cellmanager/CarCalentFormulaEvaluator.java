...
public class CarCalentFormulaEvaluator implements FormulaEvaluator {
	...
	public static final String CARBON_CALENTAMIENTO = "carbonCalentamiento";
	...
	public Object evaluate(CellGroups sourceCellGroups) {
		...
		double carbonCalent = FormulaUtil.sumatoriaCeldas(sourceCellGroups.get(CARBON_CALENTAMIENTO));

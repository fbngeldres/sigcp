 ...
 *
 * $Id: CellDirectedMultigraph.java,v 1.1 2012-05-22 21:37:22 alfredo_alfonzo Exp $
 *
 * Changes
 * -------
 ...
 */
public class CellDirectedMultigraph extends AbstractBaseGraph<Cell, DefaultEdge> implements DirectedGraph<Cell, DefaultEdge> {
	 ...
	 */
	public CellDirectedMultigraph() {
		super(new CellEdgeFactory(), true, true);
	}
}

...
import pe.com.pacasmayo.sgcp.bean.impl.TableroControlBeanImpl;
...
public class TableroControlLogic implements ConstantesFiltros,
	 ...
	 */
	public List<TableroControlBean> obtenerTablerosControl()
		...
		try {
			return (List<TableroControlBean>) beanFactory.tranformarLista(
					TableroControlQuerier.getAll(),
					TableroControlBeanImpl.class);
	 ...
	 */
	public List<TableroControlBean> obtenerTablerosControlPorUnidad(
		...
		try {
			return (List<TableroControlBean>) beanFactory.tranformarLista(
					TableroControlQuerier.findByCodigoUnidad(codigoUnidad),
					TableroControlBeanImpl.class);
	 ...
	 */
	public List<Tablerocontrol> obtenerTablerosControlDTOPorUnidad(
			Long codigoUnidad) throws LogicaException {

...
<script> var isomorphicDir = "<%=request.getContextPath()%>/registrarNotificacion/sc/"; </script>

<script type="text/javascript" language="javascript"
	src="<%=request.getContextPath()%>/registrarNotificacion/registrarNotificacion.nocache.js"></script>
</head>
	...
	<div class="content-ppal">
		...
		<div id="contenido" class="content-int">
			...
			<div class="content">
				...
				<div id="test-header" class="separator" align="center">Datos
					del planeamiento</div>
				<div id="formularioCombosInferiores"></div>
				<div id="test-header" class="separator" align="center">
					Variables de Producci&oacute;n</div>

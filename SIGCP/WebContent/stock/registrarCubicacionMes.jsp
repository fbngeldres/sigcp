...
<script> var isomorphicDir = "<%=request.getContextPath()%>/registrarCubicacion/sc/"; </script>

<script type="text/javascript" language="javascript"
	src="<%=request.getContextPath()%>/registrarCubicacion/registrarCubicacion.nocache.js"></script>
</head>
<body onload="iniciarMenu()">
	...
	<div class="content-ppal">
		...
		<div id="contenido" class="content-int">
			...
			<!--  INICIO TITULO-->
			<div class="titulo">Registrar Cubicación</div>
